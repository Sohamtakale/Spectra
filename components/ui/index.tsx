...
export interface InputProps
    ...
    // Add a dummy prop or leave empty if intentional, but for strict linting extending usually suffices
    // empty interface is generally discouraged but works if just aliasing
    _ignore?: never;
}
